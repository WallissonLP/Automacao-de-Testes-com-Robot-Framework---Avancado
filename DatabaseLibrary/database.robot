...
Exemplo 05: Fazer um select simples
    Table Must Exist    account

*** Keywords ***
Conectar no Banco de Dados
    ## PostgreSQL
    Connect To Database   psycopg   dbname=robot   user=postgres   password=postgres   host=localhost   port=5432
    ## SQLite 3
...
#     [Arguments]          ${FILE}
#     Execute SQL Script    ${CURDIR}/${FILE}
